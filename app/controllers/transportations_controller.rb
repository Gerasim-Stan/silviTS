class TransportationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @transportation.save
        format.html { redirect_to "/transportations", notice: 'Transportation was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @transportation.update_attributes(params[:transportation])
        format.html { redirect_to "/transportations", notice: 'Transportation was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to "/transportations", notice: 'Transportation was successfully deleted.' }
      format.json { head :no_content }
    end
  end
end
